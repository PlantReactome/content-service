...
public class PhysicalEntityController {
    ...
    @ResponseBody
    public Collection<PhysicalEntity> getComplexSubunits( @ApiParam(value = "The complex for which subunits are requested", defaultValue = "R-OSA-5608088", required = true)
