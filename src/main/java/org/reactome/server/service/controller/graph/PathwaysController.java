...
public class PathwaysController {
    ...
    @ResponseBody
    public Collection<? extends Pathway> getTopLevelPathways( @ApiParam(value = "Specifies the species by the taxonomy identifier (eg: 4530) or species name (eg: 'Oryza+sativa')", defaultValue = "4530", required = true)
    ...
    @ResponseBody
    public Collection<Pathway> getPathwaysFor(@ApiParam(value = "The entity that has to be present in the pathways", defaultValue = "R-OSA-8933811", required = true) @PathVariable String id,
                                                           @ApiParam(value = "The species for which the pathways are requested. Taxonomy identifier (eg: 4530) or species name (eg: 'Oryza sativa')", defaultValue = "4530") @RequestParam(required = false) String species) {
    ...
    @ResponseBody
    public Collection<Pathway> getPathwaysForAllFormsOf(@ApiParam(value = "The entity (in any of its forms) that has to be present in the pathways", defaultValue = "R-OSA-8933811", required = true) @PathVariable String id,
                                                                     @ApiParam(value = "The species for which the pathways are requested. Taxonomy identifier (eg: 4530) or species name (eg: 'Oryza sativa')", defaultValue = "4530") @RequestParam(required = false) String species) {
    ...
    @ResponseBody
    public Collection<Pathway> getPathwaysWithDiagramFor(@ApiParam(value = "The entity that has to be present in the pathways", defaultValue = "R-OSA-8933811", required = true) @PathVariable String id,
                                                                      @ApiParam(value = "The species for which the pathways are requested. Taxonomy identifier (eg: 4530) or species name (eg: 'Oryza sativa')", defaultValue = "4530") @RequestParam(required = false) String species) {
    ...
    @ResponseBody
    public Collection<Pathway> getPathwaysWithDiagramForAllFormsOf(@ApiParam(value = "The entity (in any of its forms) that has to be present in the pathways", defaultValue = "R-OSA-8933811", required = true) @PathVariable String id,
                                                                                @ApiParam(value = "The species for which the pathways are requested. Taxonomy identifier (eg: 4530) or species name (eg: 'Oryza sativa')", defaultValue = "4530") @RequestParam(required = false) String species) {
    ...
    @ResponseBody
    public Collection<? extends Pathway> getCuratedTopLevelPathways(@ApiParam(value = "Specifies the species by SpeciesName (eg: Oryza sativa) or SpeciesTaxId (eg: 4530)", defaultValue = "4530") @PathVariable String species) {
